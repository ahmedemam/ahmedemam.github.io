...
#### Built and Expanded the Internal Team

- Conducted two full hiring processes within one year
- Successfully hired **9 core team members** across engineering, design, operations, and management
...
- Collaborated with global teams, including yearly in-person visits to the Dublin headquarters to align on product strategy, engineering practices, and roadmap planning
- Participated annually in engineering and technical meetings with global clients, contributing to product discussions, technical improvements, and long-term solution planning
...
- Developed and maintained the mobile application version using **Angular**, **IONIC Framework**, **TypeScript**, **NgRx**, and managed QA workflows with Bugzilla
...
An integration and automation project evaluating multiple platforms and assembling full applications without developing every component from scratch.

- Worked with **Interlok Adaptris** and **MuleSoft** to build configurable integration pipelines
- Integrated multiple system components such as:
...
### Databases
- **SQL & NoSQL** (MySQL, MongoDB, Prisma ORM, more)

### Infrastructure & Cloud
- **AWS** (Lambda, ECS, CodeCommit), **Nginx**, **Docker**, **Terraform**

### DevOps & CI/CD
- **Git**, **GitLab CI**, **Jenkins**, **Docker Compose**, **Deployment Pipelines**

### Agile Methodologies
- **Scrum**, cross-functional team collaboration
...
[Download PDF Resume](/downloads/ahmed-abd-elaziz-emam-resume.pdf)
